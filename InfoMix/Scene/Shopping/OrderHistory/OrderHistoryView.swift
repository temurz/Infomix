...
struct OrderHistoryView: View {
    ...
    init(viewModel: OrderHistoryViewModel) {
        let input = OrderHistoryViewModel.Input(
            loadOrderStatusListTrigger: self.loadOrderStatusTrigger.asDriver(),
            loadOrderListTrigger: self.loadOrdersTrigger.asDriver(),
            reloadOrderListTrigger: self.reloadOrdersTrigger.asDriver(),
            loadMoreOrderListTrigger: self.loadMoreOrdersTrigger.asDriver(),
            selectOrderTrigger: self.selectOrderTrigger.asDriver(),
