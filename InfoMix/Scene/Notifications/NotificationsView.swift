...
struct NotificationsView: View {
    ...
    init(viewModel: NotificationsViewModel){
        let input = NotificationsViewModel.Input(loadNotificationsTrigger: self.loadNotificationsTrigger.asDriver(), reloadNotificationsTrigger: self.reloadNotificationsTrigger.asDriver(), loadMoreNotificationsTrigger: self.loadMoreNotificationsTrigger.asDriver(), moreActionTrigger: self.moreActionTrigger.asDriver())
